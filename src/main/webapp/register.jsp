<%-- 
    Created on : November, 2021, 3:35:42 PM
                 ...
                 <div class=" contact-area2">
                     ...
                     <form  action="Idcard" method="POST">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="scholar" name="txtscholar"  placeholder="Roll Number / Enrollment Number">
                        </div>

                        <div class="form-group">
                            <label >Name</label>
                            <input type="text" class="form-control" id="name" name="txtname" placeholder="Enter Full Name">
                        </div>
                        
                        <div class="form-group">
                            <label >Father's Name</label>
                            <input type="text" class="form-control" id="fname" name="txtfname" placeholder="Enter Father's Name">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label >Session</label>
                            <input type="" class="form-control" id="session" name="txtsession" placeholder="Example : 2019-2022">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="" class="form-control" name="txtmobile" id="mobile" placeholder="Example : 8959264362">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="txtemail" id="email" placeholder="name@gmail.com">
                        </div>
                        <div class="form-group">
